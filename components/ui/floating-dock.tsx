            ...
            {items.map((item, idx) => (
              ...
              >
                <Link
                  href={item.href}
                  key={item.title}
                  className="h-28 w-14 rounded-full bg-gray-50 dark:bg-neutral-900 flex items-center justify-center"
                >
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden md:flex h-20 gap-4 items-end rounded-2xl bg-gray-50 dark:bg-neutral-900 px-5 pb-4",
        className
      )}
    >
      {items.map((item) => (
